...
/**
 * DemoModel属性编辑器
 * 从一串逗号分隔的字符串直接转换为模型对象
 */
public class DemoModelEditor extends PropertyEditorSupport {

    private final static Logger LOGGER = LoggerFactory.getLogger(DemoModelEditor.class);
